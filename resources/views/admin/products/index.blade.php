...
<x-admin-layout>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        {{-- Active Products --}}
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="h-2 bg-emerald-500"></div> {{-- Top accent bar --}}
            <div class="p-4 flex items-center justify-between">
                <div>
        ...
        {{-- Low Stock Alerts --}}
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="h-2 bg-amber-500"></div> {{-- Top accent bar --}}
            <div class="p-4 flex items-center justify-between">
                <div>
                    <p class="text-base font-semibold text-gray-600">Low Stock Alerts <span class="text-sm text-gray-400 font-normal">(< {{ $lowStock }})</span></p>
        ...
        {{-- Categories --}}
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="h-2 bg-purple-500"></div> {{-- Top accent bar --}}
            <div class="p-4 flex items-center justify-between">
                <div>
    ...
    <form method="GET" class="flex flex-col gap-4" x-data x-on:change="this.$el.submit()">
        ...
        {{-- Row 1: Category & Status Filters (Live) --}}
        ...
        {{-- Row 2: Stock Filter & Clear Filters (Live) --}}
        <div class="flex flex-wrap items-center gap-3">
    ...
    {{-- 4. Product Table (Clean, Responsive Data Grid) --}}
        ...
        <div class="overflow-x-auto">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="text-gray-700 transition duration-100 hover:bg-violet-50/50"> 
                    ...
                    <td class="px-5 py-3 font-extrabold whitespace-nowrap text-gray-800">₱{{ number_format($p->price,2) }}</td>
                    <td class="px-5 py-3 whitespace-nowrap">
                    {{-- Stock Status Badge --}}
                    ...
                    <td class="px-5 py-3 whitespace-nowrap">
                    {{-- Status Toggle Button/Badge (Uses $p->status) --}}
                ...
                @empty
                <tr><td colspan="8" class="px-5 py-10 text-center text-gray-500 text-base italic bg-gray-50">
