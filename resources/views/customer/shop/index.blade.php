<x-app-layout>
    ...
    <button type="submit"
        ...
        :class="favorites.includes({{ $product->id }}) ? 'bg-red-500 text-white' : 'gradient-bg text-white'">
    ...
    <button type="submit"
        ...
        <span x-text="favorites.includes(selectedProduct.id) ? 'Remove Favorite' : 'Add to Favorite'"></span>
    </button>
</form>
